...
def post_process_en(text):
    ...
    # More compound fixes
    text = text.replace('lāzeri ir', 'lasers are')
    text = text.replace('lāzeri', 'lasers')
    text = text.replace('lāzera', 'laser')
    text = text.replace('lāzeru', 'laser')
    text = text.replace('lāzers', 'laser')
    text = text.replace('lāzergriešana', 'laser cutting')
    text = text.replace('lāzergravēšana', 'laser engraving')
    text = text.replace('gravēšana', 'engraving')
    text = text.replace('gravēšanai', 'for engraving')
    text = text.replace('griešana', 'cutting')
    text = text.replace('griešanai', 'for cutting')
    text = text.replace('marķēšana', 'marking')
    text = text.replace('marķētājs', 'marker')
    text = text.replace('marķētāji', 'markers')
    text = text.replace('marķieri', 'markers')
    text = text.replace('dzesētājs', 'chiller')
    text = text.replace('dzesētāji', 'chillers')
    text = text.replace('dzesēšana', 'cooling')
    text = text.replace('apstrāde', 'processing')
    text = text.replace('apstrādei', 'for processing')
    text = text.replace('apstrādā', 'processes')
    text = text.replace('caur ', 'through ')
    text = text.replace('Caur ', 'Through ')
    text = text.replace('saplāksnim', 'plywood')
    text = text.replace('gumijai', 'rubber')
    text = text.replace('tekstilam', 'textiles')
    text = text.replace('papīram', 'paper')
    text = text.replace('kartonam', 'cardboard')
    text = text.replace('un ', 'and ')
    text = text.replace('Un ', 'And ')
    text = text.replace('vai ', 'or ')
    text = text.replace('Vai ', 'Or ')
    text = text.replace('tam ', 'it ')
    text = text.replace('ar ', 'with ')
    text = text.replace('Ar ', 'With ')
    text = text.replace('ir ', 'is ')
    text = text.replace('Ir ', 'Is ')
    text = text.replace('tiek ', 'is ')
    text = text.replace('Tiek ', 'Is ')
    text = text.replace('nav ', 'not ')
    text = text.replace('Nav ', 'Not ')
    text = text.replace('jā ', 'yes ')
    text = text.replace('Jā ', 'Yes ')
    text = text.replace('par ', 'for ')
    text = text.replace('Par ', 'About ')
    text = text.replace('no ', 'from ')
    text = text.replace('No ', 'From ')
    text = text.replace('kā ', 'how ')
    text = text.replace('Kā ', 'How ')
    text = text.replace('kas ', 'what ')
    text = text.replace('Kas ', 'What ')
    text = text.replace('uz ', 'to ')
    text = text.replace('Uz ', 'To ')
    text = text.replace('pa ', 'by ')
    text = text.replace('pie ', 'at ')
    text = text.replace('līdz ', 'up to ')
    # Footer links that weren't caught
    text = text.replace('>CO2 Lāzeri<', '>CO2 Lasers<')
    text = text.replace('>Marķieri<', '>Markers<')
    text = text.replace('>CNC Frēzes<', '>CNC Routers<')
    text = text.replace('>Lāzermetināšana<', '>Laser Welding<')
    text = text.replace('>Par uzņēmumu<', '>About Company<')
    text = text.replace('>Atbalsts<', '>Support<')
    text = text.replace('>Dīleris Latvijā<', '>Dealer in Latvia<')
    text = text.replace('>Blogs<', '>Blog<')
    text = text.replace('>Par mums<', '>About Us<')
    text = text.replace('>Privātuma politika<', '>Privacy Policy<')
    text = text.replace('>Lietošanas noteikumi<', '>Terms of Service<')
    # Product page nav-sub labels
    text = text.replace('<span>CO2 Lāzeri:</span>', '<span>CO2 Lasers:</span>')
    text = text.replace('<span>TEYU Dzesētāji:</span>', '<span>TEYU Chillers:</span>')
    text = text.replace('<span>Reci Lampas:</span>', '<span>Reci Tubes:</span>')
    text = text.replace('<span>Metāla Lāzeri:</span>', '<span>Metal Lasers:</span>')
    text = text.replace('<span>Marķieri:</span>', '<span>Markers:</span>')
    # Spare part name spans
    text = text.replace('CO2 Lāzeram', 'for CO2 Laser')
    text = text.replace('Lēca', 'Lens')
    text = text.replace('Relejs', 'Relay')
    text = text.replace('Spogulis', 'Mirror')
    text = text.replace('Si <span', 'Si <span')
    text = text.replace('Mo <span', 'Mo <span')
    text = text.replace('Zelta', 'Gold')
    text = text.replace('Sudraba', 'Silver')
    text = text.replace('gab.</span>', 'pcs.</span>')
    # Machine cat labels
    text = text.replace('Šķiedru marķētājs · Galda', 'Fiber Marker · Desktop')
    text = text.replace('Šķiedru marķētājs · Rokas / Portatīvs', 'Fiber Marker · Handheld')
    text = text.replace('Šķiedru marķētājs · Statīvs', 'Fiber Marker · Stand')
    text = text.replace('Šķiedru marķētājs · Lielformāta', 'Fiber Marker · Large Format')
    text = text.replace('Šķiedru marķētājs · Galda / Kompakts', 'Fiber Marker · Desktop / Compact')
    text = text.replace('Šķiedru marķētājs · Galda / Slēgts', 'Fiber Marker · Desktop / Enclosed')
    text = text.replace('Šķiedru marķētājs · 3D Dinamiskais', 'Fiber Marker · 3D Dynamic')
    text = text.replace('UV marķētājs · Galda', 'UV Marker · Desktop')
    text = text.replace('CO2 marķētājs · Galda', 'CO2 Marker · Desktop')
    text = text.replace('CO2 lāzeris ·', 'CO2 Laser ·')
    text = text.replace('Šķiedru lāzeris ·', 'Fiber Laser ·')
    text = text.replace('Dzesētājs ·', 'Chiller ·')
    # Product SEO titles (only in <title>)
    text = text.replace('Industriālais Dzesētājs', 'Industrial Chiller')
    text = text.replace('Lāzeriekārtām', 'for Laser Machines')
    text = text.replace('Lāzergravēšanas Iekārta', 'Laser Engraving Machine')
    text = text.replace('Lāzergriešanas Iekārta', 'Laser Cutting Machine')
    text = text.replace('Marķēšanas Iekārta', 'Marking Machine')
    text = text.replace('Lāzermarķēšanas Iekārta', 'Laser Marking Machine')
    text = text.replace('Metāla Griešanas Iekārta', 'Metal Cutting Machine')
    text = text.replace('CO2 Lāzera Lampa', 'CO2 Laser Tube')
    text = text.replace('CO2 Lāzera Iekārta', 'CO2 Laser Machine')
    # Form
    text = text.replace('sazinies-ar-mums', 'contact-us')
    text = text.replace('Aizpildiet formu, lai saņemtu konsultāciju par lāzera iekārtām', 'Fill out the form to receive a consultation about laser machines')
    # JS comments
    text = text.replace('// Initializējam abus blokus', '// Initialize both blocks')
    # Cat tab numbers
    text = text.replace("' — Aktīvs'", "' — Active'")
    # JSON-LD product descriptions with remaining Latvian
    text = text.replace('dzesētājs CO2 lāzergravēšanas iekārtām', 'chiller for CO2 laser engraving machines')
    text = text.replace('dzesētājs lāzergriešanas iekārtām', 'chiller for laser cutting machines')
    text = text.replace('dzesētājs šķiedru lāzergriešanas iekārtām', 'chiller for fiber laser cutting machines')
    text = text.replace('dzesētājs jaudīgām lāzergriešanas iekārtām', 'chiller for high-power laser cutting machines')
    text = text.replace('industriālais dzesētājs lāzergriešanas iekārtām', 'industrial chiller for laser cutting machines')
    text = text.replace('jauda', 'power')
    text = text.replace('precizitāte', 'accuracy')
    text = text.replace('sertificēts', 'certified')
    text = text.replace('Sertificēts', 'Certified')
    text = text.replace('Piegāde Latvijā', 'Delivery in Latvia')
    text = text.replace('Piegāde un serviss', 'Delivery and service')
    text = text.replace('Oficiālais pārstāvis', 'Official Dealer')
    text = text.replace('oficiālais pārstāvis', 'official dealer')
    # Remaining inflected forms
    text = text.replace('iekārtām', 'machines')
    text = text.replace('iekārtai', 'machine')
    text = text.replace('Šķiedru ', 'Fiber ')
    text = text.replace('Galda', 'Desktop')
    text = text.replace('Aizpildiet', 'Fill out')
    text = text.replace('saņemtu', 'receive')
    text = text.replace('konsultāciju', 'consultation')
    text = text.replace('Nepieciešams', 'Need')
    text = text.replace('Pasūtiet', 'Order')
    text = text.replace('lāzergravēšanas', 'laser engraving')
    text = text.replace('lāzergriešanas', 'laser cutting')
    text = text.replace('gravēšanas', 'engraving')
    text = text.replace('griešanas', 'cutting')
    text = text.replace('dzesēšanas', 'cooling')
    text = text.replace('marķēšanas', 'marking')
    text = text.replace('apstrādes', 'processing')
    text = text.replace('ražošanas', 'production')
    text = text.replace('uzstādīšanas', 'installation')
    text = text.replace('apmācības', 'training')
    text = text.replace('kalpošanas', 'service')
    text = text.replace('piegādes', 'delivery')
    text = text.replace('pozicionēšanas', 'positioning')
    text = text.replace('savienojamība', 'connectivity')
    return text
